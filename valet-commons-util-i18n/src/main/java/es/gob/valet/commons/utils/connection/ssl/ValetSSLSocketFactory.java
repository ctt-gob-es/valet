...
/**
 * <b>File:</b><p>es.gob.valet.commons.utils.connection.ssl.ValetSSLSocketFactory.java.</p>
...
public class ValetSSLSocketFactory implements LayeredConnectionSocketFactory {
	...
	/**
	 * Constructor method for the class ValetSSLSocketFactory.java.
	 * @param sslContextParam SSL context.
	 */
	public ValetSSLSocketFactory(SSLContext sslContextParam) {
