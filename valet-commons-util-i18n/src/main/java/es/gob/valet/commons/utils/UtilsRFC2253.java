...
/**
 * <b>File:</b><p>es.gob.valet.commons.utils.UtilsRFC2253.java.</p>
...
public final class UtilsRFC2253 {
	...
	public String unscape(String str) throws IOException {
		...
		try {
			...
			// Cerramos recursos
			UtilsResources.safeCloseOutputStream(dstBAOS);
		}
	...
	private byte hexToByte(char b1, char b2) throws UnsupportedEncodingException {
		return (byte) (NumberConstants.NUM16 * valueHex(b1) + valueHex(b2));
	}
