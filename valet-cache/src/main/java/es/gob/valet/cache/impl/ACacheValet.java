...
public abstract class ACacheValet implements ICacheValet {
	...
	protected final String buildPath(String[ ] path, boolean isNodePath) throws BadPathCacheValetException {
		...
		if (path == null) {
			throw new BadPathCacheValetException(ValetExceptionConstants.COD_155, Language.getResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_003));
		}

		if (path.length == 0) {
			throw new BadPathCacheValetException(ValetExceptionConstants.COD_155, Language.getResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_005));
		}

		for (int index = 0; index < path.length; index++) {
			if (UtilsStringChar.isNullOrEmptyTrim(path[index])) {
				throw new BadPathCacheValetException(ValetExceptionConstants.COD_155, Language.getResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_006));
			}
		}
	...
	private void addObject(String path, Object key, Object value, boolean inLoadingCache) throws BadPathCacheValetException, ManagingObjectCacheValetException {
		...
		try {
			...
			getLogger().debug(Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_002, new Object[ ] { path + getSeparator() + key }));

		} catch (Exception e) {
			throw new ManagingObjectCacheValetException(ValetExceptionConstants.COD_154, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_001, new Object[ ] { e }));
		}
	...
	protected final void checkPathAndKey(String path, Object key) throws BadPathCacheValetException {
		...
		if (UtilsStringChar.isNullOrEmptyTrim(path)) {
			...
			throw new BadPathCacheValetException(ValetExceptionConstants.COD_155, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_004, new Object[ ] { getSeparator() }));
		} else if (key == null) {
			throw new BadPathCacheValetException(ValetExceptionConstants.COD_155, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_004, new Object[ ] { path }));
		}
	...
	protected final Object getObject(String path, Object key, boolean inLoadingCache) throws BadPathCacheValetException, ManagingObjectCacheValetException {
		...
		try {
			...
			throw new ManagingObjectCacheValetException(ValetExceptionConstants.COD_154, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_007, new Object[ ] { e }));
		}

		if (result == null) {
			getLogger().debug(Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_008, new Object[ ] { path + getSeparator() + key }));
		} else {
			getLogger().debug(Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_009, new Object[ ] { path + getSeparator() + key }));
		}
	...
	protected final Object removeObject(String path, Object key, boolean inLoadingCache) throws BadPathCacheValetException, ManagingObjectCacheValetException {
		...
		try {
			...
			throw new ManagingObjectCacheValetException(ValetExceptionConstants.COD_154, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_010, new Object[ ] { e }));
		}

		getLogger().debug(Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_011, new Object[ ] { path + getSeparator() + key }));
	...
	public boolean removeNode(String[ ] path, boolean inLoadingCache) throws BadPathCacheValetException, ManagingObjectCacheValetException {
		...
		try {
			...
			throw new ManagingObjectCacheValetException(ValetExceptionConstants.COD_154, Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_012, new Object[ ] { e }));
		}

		getLogger().debug(Language.getFormatResCacheGeneral(CacheGeneralMessages.CACHE_IMPL_013, new Object[ ] { fullPath }));
