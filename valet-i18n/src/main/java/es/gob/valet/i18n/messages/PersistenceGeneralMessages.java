 ...
 * @version 1.2, 19/09/2023.
 */
public class PersistenceGeneralMessages {
	 ...
	 * file messages/valet-persistence/general_xx_YY.properties.
	 */
	public static final String ERROR_IMPORTING_JSON_MAPPING_EXTENSION_INCORRECT = "errorImportJSONMappingExtensionIncorrect";
	
	/**
	 * Constant attribute that represents the name of the property <code>errorImportJSONMappingFileEmpty</code> belonging to the
	 * file messages/valet-persistence/general_xx_YY.properties.
	 */
	public static final String ERROR_IMPORTING_JSON_MAPPING_FILE_EMPTY = "errorImportJSONMappingFileEmpty";
	 ...
	 * file messages/valet-persistence/general_xx_YY.properties.
	 */
	public static final String ERROR_IMPORTING_JSON_MAPPING_FORMAT_INCORRECT = "errorImportJSONMappingFormatIncorrect";
	 ...
	 * file messages/valet-persistence/general_xx_YY.properties.
	 */
	public static final String ERROR_IMPORTING_JSON_MAPPING_TSL_MAPPING_NOT_INSTANCE = "errorImportJSONMappingTslMappingNotInstance";
}
