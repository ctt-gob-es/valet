 ...
 * @version 1.0, 27/11/2018.
 */
public interface ITslRestServiceRevocationStatus {
	 ...
	 */
	int RESULT_DETECTED_REVSTATUS_REVOKED = NumberConstants.NUM3;

	/**
	 * Constant attribute that represents a revocation status of a certificate:
	 * The certificate has been detected by the TSL and its certificate chain is not valid (expired).
	 */
	int RESULT_DETECTED_REVSTATUS_CERTCHAIN_NOTVALID = NumberConstants.NUM4;

	/**
	 * Constant attribute that represents a revocation status of a certificate:
	 * The certificate has been detected by the TSL and the service status is revoked.
	 */
	int RESULT_DETECTED_REVSTATUS_REVOKED_SERVICESTATUS = NumberConstants.NUM5;

	/**
	 * Constant attribute that represents a revocation status of a certificate:
	 * The certificate has been detected by the TSL and the service status is not valid.
	 */
	int RESULT_DETECTED_REVSTATUS_CERTCHAIN_NOTVALID_SERVICESTATUS = NumberConstants.NUM6;
