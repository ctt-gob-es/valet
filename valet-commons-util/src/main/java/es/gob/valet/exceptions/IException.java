...
public interface IExcepcion {
	...
	//
	//	/** Constant attribute that represents the error code: TreeCache can not stop because has not yet been created. */
	//	String COD_153 = "COD_153";
	//
	//	/** Constant attribute that represents the error code: Error getting / setting some type of object in the TreeCache. */
	//	String COD_154 = "COD_154";
	//
	//	/** Constant attribute that represents the error code: The path on which you plan to store some object in the TreeCache is badly constructed. */
