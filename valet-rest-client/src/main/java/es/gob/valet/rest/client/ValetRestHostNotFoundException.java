...
/** 
 * <b>File:</b><p>es.gob.valet.rest.client.ValetRestHostNotFoundException.java.</p>
 * <b>Description:</b><p> Class that manages exceptions produced by network host not found in valet rest client.</p>
...
/** 
 * <p>Class that manages exceptions produced by network host not found in valet rest client.</p>
 * <b>Project:</b><p>Platform for detection and validation of certificates recognized in European TSL.</p>
 * @version 1.1, 03/04/2023.
 */
public class ValetRestHostNotFoundException extends ValetRestException {

	/**
	 * Constant  ttribute that represents the serial version UID.
	 */
	private static final long serialVersionUID = 6380519391765548036L;

	/**
	 * Attribute that represents the object that manages the log of the class.
	 */
	private static final Logger LOGGER = LogManager.getLogger(ValetRestHostNotFoundException.class);
	 ...
	 */
	public ValetRestHostNotFoundException() {
		super();
	}
