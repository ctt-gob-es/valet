...
public class ValetRestUnknownHostException extends ValetRestException {
	 ...
	 */
	private static final long serialVersionUID = 7055451890138012763L;

	/**
	 * Attribute that represents the object that manages the log of the class.
	 */
	private static final Logger LOGGER = LogManager.getLogger(ValetRestUnknownHostException.class);
	 ...
	 */
	public ValetRestUnknownHostException() {
		super();
	}
	 ...
	 */
	public ValetRestUnknownHostException(final String errorCodeParam, final String errorDescParam) {
	 ...
	 */
	public ValetRestUnknownHostException(final String errorCodeParam, final String errorDescParam, final Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
