...
public class ValetRestUnknownHostException extends ValetRestException {
	 ...
	 */
	public ValetRestUnknownHostException(String errorCodeParam, String errorDescParam) {
	 ...
	 */
	public ValetRestUnknownHostException(String errorCodeParam, String errorDescParam, Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
