...
public class ValetRestTimeoutException extends ValetRestException {
	 ...
	 */
	public ValetRestTimeoutException(String errorCodeParam, String errorDescParam) {
	 ...
	 */
	public ValetRestTimeoutException(String errorCodeParam, String errorDescParam, Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
