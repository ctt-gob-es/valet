...
public class ValetRestConnectionRefusedException extends ValetRestException {
	 ...
	 */
	public ValetRestConnectionRefusedException(String errorCodeParam, String errorDescParam) {
	 ...
	 */
	public ValetRestConnectionRefusedException(String errorCodeParam, String errorDescParam, Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
