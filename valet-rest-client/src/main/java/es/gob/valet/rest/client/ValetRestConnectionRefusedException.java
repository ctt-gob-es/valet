...
/** 
 * <b>File:</b><p>es.gob.valet.rest.client.ValetRestConnectionRefusedException.java.</p>
 * <b>Description:</b><p> Class that manages exceptions produced by network connection refused in valet rest client.</p>
...
/** 
 * <p>Class that manages exceptions produced by network connection refused in valet rest client.</p>
 * <b>Project:</b><p>Platform for detection and validation of certificates recognized in European TSL.</p>
 * @version 1.1, 03/04/2023.
 */
public class ValetRestConnectionRefusedException extends ValetRestException {

	/**
	 * Constant  ttribute that represents the serial version UID.
	 */
	private static final long serialVersionUID = -5627545100868059247L;

	/**
	 * Attribute that represents the object that manages the log of the class.
	 */
	private static final Logger LOGGER = LogManager.getLogger(ValetRestConnectionRefusedException.class);
	 ...
	 */
	public ValetRestConnectionRefusedException() {
		super();
	}
	 ...
	 */
	public ValetRestConnectionRefusedException(final String errorCodeParam, final String errorDescParam) {
	 ...
	 */
	public ValetRestConnectionRefusedException(final String errorCodeParam, final String errorDescParam, final Exception exceptionParam) {
		super(errorDescParam);
		errorCode = errorCodeParam;
		errorDesc = errorDescParam;
