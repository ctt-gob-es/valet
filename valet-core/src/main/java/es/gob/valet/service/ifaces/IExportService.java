...
public interface IExportService {
	 ...
	 */
	byte[] signHash(byte[ ] hashByteArray) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, UnrecoverableKeyException, SignatureException, ExportException, CipherException;
