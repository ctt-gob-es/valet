...
/**
 * <b>File:</b><p>es.gob.valet.tsl.parsing.impl.ATSLBuilder.java.</p>
...
public abstract class ATSLBuilder implements ITSLBuilder {
	 ...
	 */
	private static final Logger LOGGER = LogManager.getLogger(ATSLBuilder.class);
	...
	/**
	 * {@inheritDoc}
	 * @see es.gob.valet.tsl.parsing.ifaces.ITSLBuilder#buildTSLFromXML(java.io.InputStream)
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * @see es.gob.valet.tsl.parsing.ifaces.ITSLBuilder#buildXMLfromTSL()
	 */
	@Override
