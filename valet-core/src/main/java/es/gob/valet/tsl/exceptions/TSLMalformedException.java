...
/**
 * <b>File:</b><p>es.gob.valet.tsl.exceptions.TSLMalformedException.java.</p>
 ...
 * @version 1.0, 19/10/2018.
 */
public class TSLMalformedException extends TSLException {

	/**
	 * Constant attribute that represents the serial version OID.
	 */
	private static final long serialVersionUID = 1111189235939404855L;
	 ...
	 */
	public TSLMalformedException(String errorCodeParam, String errorDescParam) {
	 ...
	 */
	public TSLMalformedException(String errorCodeParam, String errorDescParam, Exception exceptionParam) {
