...
/**
 * <b>File:</b><p>es.gob.valet.tsl.parsing.impl.common.extensions.KeyUsage.java.</p>
...
public class KeyUsage implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = 58066624919242475L;
	...
	public final boolean addNewKeyUsageBit(KeyUsageBit kub) {
		...
		if (kub != null && keyUsageBitList.size() < NumberConstants.NUM9) {
