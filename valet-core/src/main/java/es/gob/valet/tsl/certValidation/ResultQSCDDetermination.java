...
/** 
 * <b>File:</b><p>es.gob.valet.tsl.certValidation.ResultQSCDDetermination.java.</p>
 * <b>Description:</b><p>Class that represents the result obtained when executing the procedure 4.5.QSCD determination of ETSI TS 119 615 v.1.1.1.</p>
 * <b>Project:</b><p>Platform for detection and validation of certificates recognized in European TSL.</p>
 * <b>Date:</b><p>13/02/2023.</p>
...
/**
 * <p>
 * Class that represents the result obtained when executing the procedure
 * 4.5.QSCD determination of ETSI TS 119 615 v.1.1.1.
 * </p>
 * <b>Project:</b>
 * <p>
...
public class ResultQSCDDetermination implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = 4527807523300871560L;
