...
/**
 * <b>File:</b><p>es.gob.valet.tsl.parsing.ifaces.ITSLObject.java.</p>
...
public interface ITSLObject extends Serializable {
	...
	/**
	 * Gets the numbered ETSI specification of the implementation.
	 * @return String with the ETSI TS specfication number.
	 */
	String getSpecification();

	/**
	 * Gets the number version of the specification of the implementation.
