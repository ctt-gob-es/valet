...
/**
 * <b>File:</b><p>es.gob.valet.tsl.parsing.impl.common.DigitalID.java.</p>
...
public class DigitalID implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = -302993728771949045L;
		...
		try {
			switch (type) {
				case DigitalID.TYPE_X509CERTIFICATE:
					...
					in.read(x509encoded);
					x509cert = UtilsCertificate.getX509Certificate(x509encoded);
					break;
