...
public final class CommonsTslAuditTraces {
	...
	static {
		operationFieldsNamesMap.put(EventsCollectorConstants.OPERATION_TSL_TSLLOCATION, new String[ ] { EventsCollectorConstants.FIELD_NAME_TSL_TSLLOCATION, EventsCollectorConstants.FIELD_NAME_RS_PARAM_GET_XML_DATA });
		operationFieldsNamesMap.put(EventsCollectorConstants.OPERATION_TSL_COUNTRY_REGION, new String[ ] { EventsCollectorConstants.FIELD_NAME_TSL_COUNTRYREGION, EventsCollectorConstants.FIELD_NAME_RS_PARAM_GET_XML_DATA });
		operationFieldsNamesMap.put(EventsCollectorConstants.OPERATION_TSL_FINDED, new String[ ] { EventsCollectorConstants.FIELD_NAME_TSL_FINDED, EventsCollectorConstants.FIELD_NAME_TSL_COUNTRYREGION, EventsCollectorConstants.FIELD_NAME_TSL_SEQNUMBER, EventsCollectorConstants.FIELD_NAME_TSL_ISSUED, EventsCollectorConstants.FIELD_NAME_TSL_NEXTUPDATE });
		operationFieldsNamesMap.put(EventsCollectorConstants.OPERATION_TSL_CERT_DETECTED, new String[ ] { EventsCollectorConstants.FIELD_NAME_TSL_CERT_DETECTED, EventsCollectorConstants.FIELD_NAME_TSL_COUNTRYREGION, EventsCollectorConstants.FIELD_NAME_TSL_TSP_NAME, EventsCollectorConstants.FIELD_NAME_TSL_TSP_SERVICE_NAME, EventsCollectorConstants.FIELD_NAME_TSL_TSP_SERVICE_HISTORIC_NAME });
		operationFieldsNamesMap.put(EventsCollectorConstants.OPERATION_TSL_CERT_VALIDATED, new String[ ] { EventsCollectorConstants.FIELD_NAME_TSL_CERT_VALIDATED, EventsCollectorConstants.FIELD_NAME_TSL_CERT_STATUS, EventsCollectorConstants.FIELD_NAME_TSL_CERT_STATUS_BY_TSPSERVICE, EventsCollectorConstants.FIELD_NAME_TSL_CERT_STATUS_BY_DPAIA, EventsCollectorConstants.FIELD_NAME_TSL_COUNTRYREGION, EventsCollectorConstants.FIELD_NAME_TSL_TSP_NAME, EventsCollectorConstants.FIELD_NAME_TSL_TSP_SERVICE_NAME, EventsCollectorConstants.FIELD_NAME_TSL_TSP_SERVICE_HISTORIC_NAME });
	}
	...
	public static void addTslLocationOperationTrace(String transactionId, String tslLocation, Boolean getTslXmlData) {
		...
		EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_TSLLOCATION, tslLocation, getTslXmlDataString);
	}
	...
	public static void addTslCountryRegionTrace(String transactionId, String tslCountryRegion, Boolean getTslXmlData) {
		String getTslXmlDataString = getTslXmlData == null ? null : getTslXmlData.toString();
		EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_COUNTRY_REGION, tslCountryRegion, getTslXmlDataString);
	}
	...
	public static void addTslFindedTrace(String transactionId, boolean tslFinded, String tslCountryRegion, Integer sequenceNumber, DateString issued, DateString nextUpdate) {
		...
		if (tslFinded) {
			EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_FINDED, Boolean.toString(tslFinded), tslCountryRegion, sequenceNumber.toString(), issued.toString(), nextUpdate.toString());
		} else {
			EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_FINDED, Boolean.toString(tslFinded));
		}
	...
	public static void addTslCertDetected(String transactionId, boolean certDetected, String tslCountryRegion, String tspName, String tspServiceName, String tspServiceHistoricName) {
		EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_CERT_DETECTED, Boolean.toString(certDetected), tslCountryRegion, tspName, tspServiceName, tspServiceHistoricName);
	}
	...
	public static void addTslCertValidated(String transactionId, boolean certValidated, Integer certStatus, Boolean tspServiceStatus, Boolean dpAiaStatus, String tslCountryRegion, String tspName, String tspServiceName, String tspServiceHistoricName) {
		...
		EventsCollector.addTrace(transactionId, EventsCollectorConstants.OPERATION_TSL_CERT_VALIDATED, Boolean.toString(certValidated), translateCertStatusCode(certStatus), tspServiceStatusString, dpAiaStatusString, tslCountryRegion, tspName, tspServiceName, tspServiceHistoricName);
	}
	...
	private static String translateCertStatusCode(Integer certStatus) {
		...
		if (certStatus != null) {
			...
			switch (certStatus.intValue()) {
				case ValidatorResultConstants.RESULT_NOT_DETECTED:
					result = EventsCollectorConstants.FIELD_VALUE_UNKNOWN;
					break;
				...
				case ValidatorResultConstants.RESULT_DETECTED_STATE_REVOKED_SERVICESTATUS:
					result = EventsCollectorConstants.FIELD_VALUE_REVOKED;
					break;
				...
				case ValidatorResultConstants.RESULT_DETECTED_STATE_CERTCHAIN_NOTVALID_SERVICESTATUS:
					result = EventsCollectorConstants.FIELD_VALUE_CERTCHAINNOTVALID;
					break;

				case ValidatorResultConstants.RESULT_DETECTED_STATE_VALID:
				default:
					result = EventsCollectorConstants.FIELD_VALUE_OK;
					break;
			}
