...
#JAVA_OPTS="$JAVA_OPTS -Dlogging.config=file:/opt/valet/config/valet-rest-log4j2.xml"
JAVA_OPTS="$JAVA_OPTS -Dlogging.config=file:/opt/valet/config/valet-web-log4j2.xml"
