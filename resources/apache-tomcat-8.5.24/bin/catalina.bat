...
set "JAVA_OPTS=%JAVA_OPTS% -Dvalet.config.path=[PROPERTIES SETTING FOLDER PATH]"
set "JAVA_OPTS=%JAVA_OPTS% -Dlog4j.configuration.valet.rest=[PROPERTIES SETTING FOLDER PATH]/valet-rest-log4j2.xml 
set "JAVA_OPTS=%JAVA_OPTS% -Dlog4j.configuration.valet.web=[PROPERTIES SETTING FOLDER PATH]/valet-web-log4j2.xml 
