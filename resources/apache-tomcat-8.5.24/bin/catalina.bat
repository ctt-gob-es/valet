...
#set "JAVA_OPTS=%JAVA_OPTS% -Dlogging.config=file:[PROPERTIES SETTING FOLDER PATH]/valet-rest-log4j2.xml
set "JAVA_OPTS=%JAVA_OPTS% -Dlogging.config=file:[PROPERTIES SETTING FOLDER PATH]/valet-web-log4j2.xml
