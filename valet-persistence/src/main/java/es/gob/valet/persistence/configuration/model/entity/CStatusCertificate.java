...
public class CStatusCertificate implements Serializable {
	 ...
	 * @param idCStatusCertificate The value for the attribute {@link #idCStatusCertificate}.
	 */
	public void setIdStatusCertificate(Long idCStatusCertificate) {
		this.idStatusCertificate = idCStatusCertificate;
	}
