...
public class KeystoreService implements IKeystoreService {
	...
	public void storeCertificate(String alias, Certificate certificate, Key key, Long statusCert, boolean validationCert, Keystore ksEntity) throws CryptographyException {
		...
		LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_001, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		try {
			...
			LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_002, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		}
	...
	private void addEntryToKsJavaAndUpdateKsEntity(String alias, Certificate cert, Key key, Keystore ksEntity) throws KeyStoreException, CryptographyException, CommonUtilsException {
		try {
			...
			// Añado la nueva entrada al keystore de Java
			if (key == null) {
	...
	public void updateCertificateAlias(String oldEntryAlias, String newEntryAlias, Keystore ksEntity) throws CryptographyException {
		...
		LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_010, new Object[ ] { oldEntryAlias, newEntryAlias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		try {
			...
			String errorMsg = Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_016, new Object[ ] { oldEntryAlias, newEntryAlias, Language.getResPersistenceConstants(ksEntity.getTokenName()) });
			LOGGER.error(errorMsg, e);
			throw new CryptographyException(ValetExceptionConstants.COD_190, errorMsg, e);
		} finally {
			LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_011, new Object[ ] { oldEntryAlias, newEntryAlias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		}
	...
	private Object getPrivateKey(String alias, Keystore ksEntity) throws CryptographyException {
		LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_021, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		try {
			// Comprobamos que el alias no sea nulo...
			CryptographyValidationUtils.checkIsNotNull(alias, Language.getResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_004));
			...
			String errorMsg = Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_024, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) });
			LOGGER.error(errorMsg, e);
			throw new CryptographyException(ValetExceptionConstants.COD_190, errorMsg, e);
		} finally {
			LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_022, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		}
	}
	...
	public Certificate getCertificate(String alias, Keystore ksEntity) throws CryptographyException {
		...
		LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_017, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		try {
			// Comprobamos que el alias no sea nulo.
			CryptographyValidationUtils.checkIsNotNull(alias, Language.getResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_004));
			...
			String errorMsg = Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_020, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) });
			LOGGER.error(errorMsg, e);
			throw new CryptographyException(ValetExceptionConstants.COD_190, errorMsg, e);
		} finally {
			LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_018, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		}
	...
	public void removeEntry(String alias, Keystore ksEntity) throws CryptographyException {
		...
		LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_070, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		...
		try {
			...
			String errorMsg = Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_072, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) });
			LOGGER.error(errorMsg, e);
			throw new CryptographyException(ValetExceptionConstants.COD_190, errorMsg, e);
		} finally {
			LOGGER.info(Language.getFormatResCoreGeneral(CoreGeneralMessages.STANDARD_KEYSTORE_071, new Object[ ] { alias, Language.getResPersistenceConstants(ksEntity.getTokenName()) }));
		}
