 ...
 * <b>Description:</b><p>Class that contains all the planner types IDs.</p>
...
/**
 * <p>Class that contains all the planner types IDs.</p>
 * <b>Project:</b><p>Platform for detection and validation of certificates recognized in European TSL.</p>
 * @version 1.1, 19/09/2023.
 */
public class PlannerTypeIdConstants {

	/**
	 * Constant attribute that represents the ID to identify the Planner Type - Daily.
	 */
	public static final Long PLANNER_TYPE_0_DAILY = 0L;

	/**
	 * Constant attribute that represents the ID to identify the Planner Type - Period.
	 */
	public static final Long PLANNER_TYPE_1_PERIOD = 1L;

	/**
	 * Constant attribute that represents the ID to identify the Planner Type - ByDate.
	 */
	public static final Long PLANNER_TYPE_2_BYDATE = 2L;
