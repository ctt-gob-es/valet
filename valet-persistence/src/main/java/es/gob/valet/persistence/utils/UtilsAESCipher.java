...
/**
 * <b>File:</b><p>es.gob.valet.persistence.utils.UtilsAESCipher.java.</p>
...
public final class UtilsAESCipher {
	...
	private UtilsAESCipher() {
		key = new SecretKeySpec(StaticValetConfig.getProperty(StaticValetConfig.AES_PASSWORD).getBytes(), StaticValetConfig.getProperty(StaticValetConfig.AES_ALGORITHM));
	}
	...
	public static boolean testCipher(String newAES) {
		...
		try {
			...
			SecretKeySpec newKey = new SecretKeySpec(aesKeyBytes, StaticValetConfig.getProperty(StaticValetConfig.AES_ALGORITHM));
