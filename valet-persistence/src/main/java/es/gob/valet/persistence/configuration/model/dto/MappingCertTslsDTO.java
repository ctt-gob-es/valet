...
public class MappingCertTslsDTO implements Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((idMappingCertTsl == null) ? 0 : idMappingCertTsl.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MappingCertTslsDTO other = (MappingCertTslsDTO) obj;
		if (idMappingCertTsl == null) {
			if (other.idMappingCertTsl != null)
				return false;
		} else if (!idMappingCertTsl.equals(other.idMappingCertTsl))
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
