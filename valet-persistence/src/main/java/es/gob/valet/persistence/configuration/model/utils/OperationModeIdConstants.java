 ...
 * <b>Description:</b><p>Class that contains all the IDs of the authentication types for the
 * connections.</p>
...
/**
 * <p>Class that contains all the IDs of the association types for the
 * mappings of the system.</p>
 * <b>Project:</b><p>Platform for detection and validation of certificates recognized in European TSL.</p>
 * @version 1.1, 19/09/2023.
 */
public class OperationModeIdConstants {
	 ...
	 */
	public static final Long ID_NONE_AUTHENTICATION = 2L;

	/**
	 * Constant attribute that represents the ID to identify the basic authentication connection type.
	 */
	public static final Long ID_BASIC_AUTHENTICATION = 3L;

	/**
	 * Constant attribute that represents the ID to identify the NTLM authentication connection type.
	 */
	public static final Long ID_NTLM_AUTHENTICATION = 4L;

	/**
	 * Constant attribute that represents the ID to identify the basic connection type.
	 */
	public static final int ID_NONE_INTVALUE = 1;

	/**
	 * Constant attribute that represents the ID to identify the none authentication connection type.
	 */
	public static final int ID_NONE_AUTHENTICATION_INTVALUE = 2;

	/**
	 * Constant attribute that represents the ID to identify the basic authentication connection type.
	 */
	public static final int ID_BASIC_AUTHENTICATION_INTVALUE = 3;

	/**
	 * Constant attribute that represents the ID to identify the NTLM authentication connection type.
	 */
	public static final int ID_NTLM_AUTHENTICATION_INTVALUE = 4;
