...
COMMENT ON COLUMN "EXTERNAL_ACCESS"."LAST_CONN" IS 'Valor que indica la fehca de la última conexión.';
...
-- ######################################################## NUEVOS CAMPOS TABLA 'CONF_SERVER_MAIL'########################################################

ALTER TABLE "CONF_SERVER_MAIL" ADD "CONNETION_TIMEOUT"  Number(10,0);
