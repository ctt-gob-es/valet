...
-- TABLA USER_VALET 
Insert into USER_VALET(ID_USER_VALET, NAME, SURNAMES, EMAIL, IS_BLOCKED, ATTEMPTS_NUMBER, LAST_ACCESS, IP_LAST_ACCESS, NIF)Values
   (SQ_USER_VALET.NEXTVAL, 'Admin', 'Admin Admin', 'admin@ricoh.es', 'N', 0, null, null, '11111111X');
...
Insert into ALARM (ID_ALARM, DESCRIPTION, TIME_BLOCK, ACTIVE)
  ...
  Insert into ALARM (ID_ALARM, DESCRIPTION, TIME_BLOCK, ACTIVE)
  Values ('ALM012', 'ALARMDESC012', null, 'Y');
