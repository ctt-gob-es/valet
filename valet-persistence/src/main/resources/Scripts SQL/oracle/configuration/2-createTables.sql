...
CREATE TABLE "LOGICAL_FIELD"(
  ...
  "IDENTIFICATOR" Varchar2(255) NOT NULL UNIQUE
) INITRANS 1 MAXTRANS 255 NOCACHE;
...
CREATE TABLE "TSL_MAPPING"(
	"ID_SERVICE" Number(19, 0) NOT NULL,
	"ID_LOGICAL_FIELD" Number(19,0) NOT NULL,
	"LOGICAL_FIELD_TYPE" Number(1,0) NOT NULL,
	"LOGICAL_FIELD_VALUE" Varchar2(256) NOT NULL
) INITRANS 1 MAXTRANS 255 NOCACHE;
ALTER TABLE "TSL_MAPPING" ADD CONSTRAINT "PK_ID_SERVICE_LOGICAL_FIELD" PRIMARY KEY ("ID_SERVICE","ID_LOGICAL_FIELD");
...
COMMENT ON COLUMN "TSL_MAPPING"."LOGICAL_FIELD_TYPE" IS 'Tipo de asociación. (EJ: 0-Libre, 1-Simple)';
