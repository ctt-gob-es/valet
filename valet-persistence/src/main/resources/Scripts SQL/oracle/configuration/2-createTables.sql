...
-- Table C_ASSOCIATION_TYPE
CREATE TABLE "C_ASSOCIATION_TYPE"(
  "ID_ASSOCIATION_TYPE" Number(19,0) NOT NULL,
  "TOKEN_NAME" Varchar2(30) NOT NULL
) INITRANS 1 MAXTRANS 255 NOCACHE;
ALTER TABLE "C_ASSOCIATION_TYPE" ADD CONSTRAINT "ID_ASSOCIATION_TYPE" PRIMARY KEY ("ID_ASSOCIATION_TYPE");
COMMENT ON TABLE "C_ASSOCIATION_TYPE" IS 'Tabla que almacena constantes relacionadas con el tipo de asociación para un mapeo.';
COMMENT ON COLUMN "C_ASSOCIATION_TYPE"."ID_ASSOCIATION_TYPE" IS 'Identificador de la tabla.';
COMMENT ON COLUMN "C_ASSOCIATION_TYPE"."TOKEN_NAME" IS 'Valor que representa el token con la descripción almacenada en cada archivo de propiedades por idioma.';
...
COMMENT ON COLUMN "TSL_COUNTRY_REGION_MAPPING"."ID_ASSOCIATION_TYPE" IS 'Identificador del tipo de asociación aplicada en este mapeo. En principio solo se permiten tipo simple o tipo constante.';
...
CREATE TABLE "CONF_SERVER_MAIL"(
	...
	"TLS_ENABLED" Char(1) DEFAULT 'N' NOT NULL,
	"CERTIFICATE_FILE" Blob NULL,
	"ORIGINAL_NAME_FILE" Varchar2(100) NULL
) INITRANS 1 MAXTRANS 255 NOCACHE;
...
CREATE TABLE "APPLICATION"(
  ...
  "NAME" Varchar2(255) NOT NULL, 
   "RESPONSIBLE_NAME" Varchar2(255) NOT NULL,
  "RESPONSIBLE_SURNAMES" Varchar2(255) NOT NULL,
  "RESPONSIBLE_MAIL" Varchar2(255) NOT NULL,
  "RESPONSIBLE_PHONE" Varchar2(255) NOT NULL
);
ALTER TABLE "APPLICATION" ADD CONSTRAINT "ID_APPLICATION" PRIMARY KEY ("ID_APPLICATION");
ALTER TABLE "APPLICATION" ADD CONSTRAINT "APP_UNIQUE_IDENTIFICATOR" UNIQUE ("IDENTIFICATOR");
COMMENT ON TABLE "APPLICATION" IS 'Tabla que almacena toda la información relativa a una aplicación.';
COMMENT ON COLUMN "APPLICATION"."ID_APPLICATION" IS 'Identificador de la tabla.';
COMMENT ON COLUMN "APPLICATION"."IDENTIFICATOR" IS 'Valor que representa el identificador de la aplicación en el sistema.';
COMMENT ON COLUMN "APPLICATION"."NAME" IS 'Valor que representa el nombre de la aplicación.';
COMMENT ON COLUMN "APPLICATION"."RESPONSIBLE_NAME" IS 'Valor que representa el nombre del responsable de la aplicación.';
COMMENT ON COLUMN "APPLICATION"."RESPONSIBLE_SURNAMES" IS 'Valor que representa los apellidos del responsable de la aplicación.';
COMMENT ON COLUMN "APPLICATION"."RESPONSIBLE_MAIL" IS 'Valor que representa el e-mail del responsable de la aplicación.';
COMMENT ON COLUMN "APPLICATION"."RESPONSIBLE_PHONE" IS 'Valor que representa el teléfono del responsable de la aplicación.';
...
ALTER TABLE "TSL_DATA" ADD CONSTRAINT "R_TD_ICR" FOREIGN KEY ("ID_COUNTRY_REGION") REFERENCES "TSL_COUNTRY_REGION" ("ID_COUNTRY_REGION");
...
COMMENT ON COLUMN "EXTERNAL_ACCESS"."ID_COUNTRY_REGION" IS 'Clave foránea a la tabla de regiones de países.';
...
-- Table VALET_SERVER
CREATE TABLE "VALET_SERVER" (
	"ID_VALET_SERVER" NUMBER(19,0) NOT NULL,
	"SERVER_NAME" VARCHAR2(255 CHAR) NOT NULL,
	"SERVER_URL" VARCHAR2(4000 CHAR) NOT NULL,
	"APPLICATION" VARCHAR2(100 CHAR) NOT NULL,
	"VERSION" NUMBER(1,0) NOT NULL,
	"CONNECTION_TIMEOUT" NUMBER
) INITRANS 1 MAXTRANS 255 NOCACHE;

ALTER TABLE "VALET_SERVER" ADD CONSTRAINT "PK_VALET_SERVER" PRIMARY KEY ("ID_VALET_SERVER");

COMMENT ON TABLE "VALET_SERVER" IS 'Tabla que almacena la configuraci�n de los servidores valET.';
COMMENT ON COLUMN "VALET_SERVER"."ID_VALET_SERVER" IS 'Identificador �nico del servidor.';
COMMENT ON COLUMN "VALET_SERVER"."SERVER_NAME" IS 'Nombre descriptivo del servidor.';
COMMENT ON COLUMN "VALET_SERVER"."SERVER_URL" IS 'URL donde est�n desplegados los servicios de valET.';
COMMENT ON COLUMN "VALET_SERVER"."APPLICATION" IS 'Identificador de la aplicaci�n asociada.';
COMMENT ON COLUMN "VALET_SERVER"."VERSION" IS 'Versi�n de valET: 1 si es v1.1, 2 si es v1.2 o superior.';
COMMENT ON COLUMN "VALET_SERVER"."CONNECTION_TIMEOUT" IS 'Tiempo de espera para la conexi�n.';
