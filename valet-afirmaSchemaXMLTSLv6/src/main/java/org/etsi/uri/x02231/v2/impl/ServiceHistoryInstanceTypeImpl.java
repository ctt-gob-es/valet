 ...
 */
public class ServiceHistoryInstanceTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.etsi.uri.x02231.v2.ServiceHistoryInstanceType
{
    ...
    public org.etsi.uri.x02231.v2.ExtensionsListType getServiceInformationExtensions()
    {
        synchronized (monitor())
        {
            ...
            target = (org.etsi.uri.x02231.v2.ExtensionsListType)get_store().find_element_user(SERVICEINFORMATIONEXTENSIONS$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setServiceInformationExtensions(org.etsi.uri.x02231.v2.ExtensionsListType serviceInformationExtensions)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.etsi.uri.x02231.v2.ExtensionsListType)get_store().add_element_user(SERVICEINFORMATIONEXTENSIONS$10);
            }
