 ...
 */
public class TrustServiceProviderListDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.etsi.uri.x02231.v2.TrustServiceProviderListDocument
{
    ...
    public org.etsi.uri.x02231.v2.TrustServiceProviderListType getTrustServiceProviderList()
    {
        synchronized (monitor())
        {
            ...
            target = (org.etsi.uri.x02231.v2.TrustServiceProviderListType)get_store().find_element_user(TRUSTSERVICEPROVIDERLIST$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setTrustServiceProviderList(org.etsi.uri.x02231.v2.TrustServiceProviderListType trustServiceProviderList)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.etsi.uri.x02231.v2.TrustServiceProviderListType)get_store().add_element_user(TRUSTSERVICEPROVIDERLIST$0);
            }
