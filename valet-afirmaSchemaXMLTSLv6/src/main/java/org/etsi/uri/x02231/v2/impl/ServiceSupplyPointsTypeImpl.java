 ...
 */
public class ServiceSupplyPointsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.etsi.uri.x02231.v2.ServiceSupplyPointsType
{
     ...
     */
    public org.etsi.uri.x02231.v2.NonEmptyURIType[] xgetServiceSupplyPointArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.etsi.uri.x02231.v2.NonEmptyURIType xgetServiceSupplyPointArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.etsi.uri.x02231.v2.NonEmptyURIType target = null;
            target = (org.etsi.uri.x02231.v2.NonEmptyURIType)get_store().find_element_user(SERVICESUPPLYPOINT$0, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void xsetServiceSupplyPointArray(org.etsi.uri.x02231.v2.NonEmptyURIType[]serviceSupplyPointArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetServiceSupplyPointArray(int i, org.etsi.uri.x02231.v2.NonEmptyURIType serviceSupplyPoint)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.etsi.uri.x02231.v2.NonEmptyURIType insertNewServiceSupplyPoint(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.etsi.uri.x02231.v2.NonEmptyURIType target = null;
            target = (org.etsi.uri.x02231.v2.NonEmptyURIType)get_store().insert_element_user(SERVICESUPPLYPOINT$0, i);
            return target;
        }
    }
     ...
     */
    public org.etsi.uri.x02231.v2.NonEmptyURIType addNewServiceSupplyPoint()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.etsi.uri.x02231.v2.NonEmptyURIType target = null;
            target = (org.etsi.uri.x02231.v2.NonEmptyURIType)get_store().add_element_user(SERVICESUPPLYPOINT$0);
            return target;
        }
    }
