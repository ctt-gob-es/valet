 ...
 */
public class AdditionalServiceInformationTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AdditionalServiceInformationType
{
     ...
     */
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType getOtherInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType target = null;
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType)get_store().find_element_user(OTHERINFORMATION$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOtherInformation(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType otherInformation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType)get_store().add_element_user(OTHERINFORMATION$4);
            }
