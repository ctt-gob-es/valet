 ...
 */
public class TSLTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.TSLTypeDocument
{
    ...
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType xgetTSLType()
    {
        synchronized (monitor())
        {
            ...
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().find_element_user(TSLTYPE$0, 0);
            return target;
        }
    }
    ...
    public void xsetTSLType(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType tslType)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().add_element_user(TSLTYPE$0);
            }
            target.set(tslType);
        }
    }
