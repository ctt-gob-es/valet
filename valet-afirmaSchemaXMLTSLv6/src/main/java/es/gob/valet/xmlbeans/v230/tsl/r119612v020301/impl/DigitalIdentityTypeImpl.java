 ...
 */
public class DigitalIdentityTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.DigitalIdentityType
{
     ...
     */
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType getOther()
    {
        synchronized (monitor())
        {
            check_orphaned();
            es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType target = null;
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType)get_store().find_element_user(OTHER$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOther(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType other)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType)get_store().add_element_user(OTHER$8);
            }
            target.set(other);
        }
    }
     ...
     */
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AnyType addNewOther()
    {
        synchronized (monitor())
        {
            check_orphaned();
