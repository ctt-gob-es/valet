 ...
 * Java type: es.gob.afirma.xmlbeans.v230.tsl.r119612v020101.ServiceStatusDocument
 *
 ...
 */
public class ServiceStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ServiceStatusDocument
{
    ...
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType xgetServiceStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().find_element_user(SERVICESTATUS$0, 0);
            return target;
        }
    }
    ...
    public void xsetServiceStatus(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType serviceStatus)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().add_element_user(SERVICESTATUS$0);
            }
