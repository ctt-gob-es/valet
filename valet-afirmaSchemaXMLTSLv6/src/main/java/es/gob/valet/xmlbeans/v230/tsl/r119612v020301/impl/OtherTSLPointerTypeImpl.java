 ...
 */
public class OtherTSLPointerTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.OtherTSLPointerType
{
     ...
     */
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType xgetTSLLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType target = null;
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().find_element_user(TSLLOCATION$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTSLLocation(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType tslLocation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.NonEmptyURIType)get_store().add_element_user(TSLLOCATION$2);
            }
    ...
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AdditionalInformationType getAdditionalInformation()
    {
        synchronized (monitor())
        {
            ...
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AdditionalInformationType)get_store().find_element_user(ADDITIONALINFORMATION$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setAdditionalInformation(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AdditionalInformationType additionalInformation)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.AdditionalInformationType)get_store().add_element_user(ADDITIONALINFORMATION$4);
            }
