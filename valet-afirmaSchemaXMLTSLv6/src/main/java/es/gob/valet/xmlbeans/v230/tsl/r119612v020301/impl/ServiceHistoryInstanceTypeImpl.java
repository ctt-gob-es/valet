 ...
 */
public class ServiceHistoryInstanceTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ServiceHistoryInstanceType
{
    
    public ServiceHistoryInstanceTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SERVICEINFORMATIONEXTENSIONS$10 = 
    ...
    public es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ExtensionsListType getServiceInformationExtensions()
    {
        synchronized (monitor())
        {
            ...
            target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ExtensionsListType)get_store().find_element_user(SERVICEINFORMATIONEXTENSIONS$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetServiceInformationExtensions()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SERVICEINFORMATIONEXTENSIONS$10) != 0;
        }
    }
    ...
    public void setServiceInformationExtensions(es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ExtensionsListType serviceInformationExtensions)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (es.gob.valet.xmlbeans.v230.tsl.r119612v020301.ExtensionsListType)get_store().add_element_user(SERVICEINFORMATIONEXTENSIONS$10);
            }
    ...
    public void unsetServiceInformationExtensions()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SERVICEINFORMATIONEXTENSIONS$10, 0);
        }
    }
}
